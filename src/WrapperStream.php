...
/**
 * Decorator class that does not do anything except
 * wrap other PSR-7 StreamInterface
 *
 * @author Zamrony P. Juhara <zamronypj@yahoo.com>
 */
class WrapperStream implements StreamInterface
{
    /**
    ...
    {
        return (string) $this->actualStream;
    }
    ...
    {
        return $this->actualStream->detach();
    }
    ...
    {
        return $this->actualStream->getSize();
    }
